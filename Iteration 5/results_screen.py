...
def results_screen_init():
    global result_instance_arr, result_instance_pointer, current_track, username
...
def results_screen_loop(event_list):
    ...
    TRACK_PB = get_player_best_lap(current_track.track_name, username.text)
    ...
    if current_track.winner_name == username.text:
    ...
    win.blit(ORBITRON_FONT_INFO.render( username.text + " Time: " + str(PLAYER_TIME), 1, (200, 200, 200)), (290, 140))
    ...
    draw_leaderboard_panel(
        ...
        track_id=None,
        track_name=current_track.track_name,  # Use the track name directly
